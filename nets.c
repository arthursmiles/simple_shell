...
ssize_t r = 0;
size_t len_p = 0;
if (!*len) /* Fill any space left in the buffer */
{
...
/**
* get_input - gets a line below the newline
* @info: parameter struct.
* Return: (bytes) read
*/
...
*buf_p = p; /* pass the pointer to current command position */
